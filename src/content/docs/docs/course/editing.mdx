...
description: This is a step by step guide on how to use whiteowl course builder to update your existing course
---
...
2. **Click on the 3 dots on the course cards and click on the edit option.**
    ![edit button](https://assets.trywhiteowl.com/edit-button.png)
