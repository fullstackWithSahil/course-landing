...
---
# API Documentation: Integrating with Whiteowl

Welcome to the whiteowl API documentation! This guide will help course creators seamlessly integrate our platform with their existing tools and workflows. Our API allows you to programmatically send emails, manage email templates, and handle your leads database (add, update, delete).
...
**Base URL:** `https://apis.trywhiteowl.com/`
