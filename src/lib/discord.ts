...
const webHooks ={
    ...
    payments:"https://discord.com/api/webhooks/1447805463319154731/k9N_VulH1Hdfx-uFnVQpzd7BR1ZgfbD7-kgr156hodhN2K6vQh8vCG7POaUWW_3KXa-3",
    notification:"https://discord.com/api/webhooks/1406893124847927306/nKllDw4V5IngilsSGkB7DQhFMkIa1v2_ct5wQ-Rlz1X0ZW9p7SQ6uYLIAIMXViPnMG1h",
} as const;

export default async function sendDiscordMessage(message: string, channels: keyof typeof webHooks) {
