			...
			<section className="py-20 px-6 bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900 text-white">
				<div className="max-w-5xl mx-auto">
					...
					<div className="text-center">
						...
						<Link href="https://cal.com/buisnesstools/consultancy" className="bg-transparent hover:bg-white/10 text-white font-semibold py-4 px-8 rounded-lg transition-all duration-200 border-2 border-white/30 hover:border-white/50 inline-flex items-center mb-4">
