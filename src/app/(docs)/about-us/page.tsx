...
import comparison from "@/assets/custom-vs-templete.jpg";
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative py-24 px-6 bg-linear-to-br from-slate-900 via-indigo-900 to-slate-900 overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto relative z-10 text-center">
                    ...
                    <p className="text-xl md:text-2xl text-slate-300 leading-relaxed">
                        We're not just another SaaS platform. We're a
                        Partner-as-a-Service committed to your success.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20 px-6 bg-white">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6 leading-tight">
                        Tired of clunky, cookie-cutter websites built with
                        no-code platforms like Kajabi or Teachable?
                    </h2>
                    <div className="prose prose-lg max-w-none text-slate-700 space-y-4">
                        <p className="text-xl leading-relaxed">
                            These generic solutions don't just look outdated—
                            <strong>
                                they actively hurt your SEO and credibility.
                            </strong>
                        </p>
                        <p className="text-lg leading-relaxed">
                            At BusinessTools, we believe your expertise deserves
                            a professional online presence that reflects the
                            quality of your content.
                        </p>
                        <p className="text-lg leading-relaxed">
                            We deliver{" "}
                            <strong>hand-coded, SEO-optimized websites</strong>{" "}
                            with designs personalized to your brand.
                        </p>
                    </div>
            ...
            <section className="py-16 px-6 bg-slate-50">
                <div className="max-w-6xl mx-auto flex items-center justify-center">
                    <Image
                        src={comparison}
                        alt="Comparison between generic no-code platform and BusinessTools custom solution"
                            ...
                            <div className="space-y-6 text-lg text-slate-700 leading-relaxed">
                                <p>
                                    <strong className="text-slate-900">
                                        BusinessTools is a passionate two-person
                                        team based in India
                                    </strong>{" "}
                                    with a big dream: empowering knowledge
                                    creators to build thriving online
                                    businesses.
                                </p>
                                <p>
                                    We understand that starting a course or
                                    community isn't just about learning
                                    software—
                                    <strong className="text-slate-900">
                                        it's about building a sustainable
                                        business.
                                    </strong>{" "}
                                    And that journey can feel overwhelming.
                                </p>
                                <p className="text-xl font-bold text-indigo-600">
                                    That's why we're not just another SaaS
                                    platform. We're a Partner-as-a-Service.
                                </p>
                            </div>
                        </div>

                        <div className="rounded-2xl aspect-square flex items-center justify-center p-8">
                            <Image
                                src={whoWeAre}
                                alt="Founders of BusinessTools working together"
                                className="max-w-full h-auto rounded-lg shadow-lg"
                            />
                        </div>
                    </div>
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-indigo-100 leading-relaxed">
                            We don't just hand you a website and disappear. From
                            launch day forward, we're your dedicated partner.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-white/20 mb-12">
                        <p className="text-xl md:text-2xl text-white leading-relaxed mb-6">
                            Our exceptional support goes far beyond "how to use
                            our software."
                        </p>
                        <p className="text-lg text-indigo-100 leading-relaxed">
                            We're here to help you navigate the real challenges
                            of running an online education business—from
                            marketing strategy to pricing decisions to community
                            management.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-12">
                        <div className="text-center">
                            ...
                            <p className="text-indigo-100">
                                Launch and promote your courses effectively
                            </p>
                        </div>
                        <div className="text-center">
                            <div className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-4">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-indigo-100">
                                Build engaged, thriving communities
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-center">
                        <div className="inline-block bg-white/20 backdrop-blur-sm px-8 py-6 rounded-2xl border border-white/30">
                            <p className="text-lg font-semibold mb-2">
                                Every BusinessTools client gets:
                            </p>
                            <p className="text-2xl md:text-3xl font-bold">
                                Free Consultancy & Resources
                            </p>
                            <p className="text-indigo-200 mt-2 italic">
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-12 mb-16">
                        ...
                        <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200">
                            ...
                            <p className="text-slate-700 leading-relaxed">
                                To help creators, technicians, and skilled
                                professionals build successful education
                                businesses without worrying about the tech.
                            </p>
                            <p className="text-slate-900 font-semibold mt-4">
                                You focus on creating great content. We'll
                        ...
                        <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200">
                            ...
                            <p className="text-slate-700 leading-relaxed">
                                To provide educators with all the tools they
                                need to run their online business under one
                                roof—so they can spend less time troubleshooting
                        ...
                        <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600 text-sm ml-7">
                                        Your success is our success. Transparent
                                        and reliable.
                                    </p>
                                </div>
                                <div>
                                    ...
                                    <p className="text-slate-600 text-sm ml-7">
                                        Here when you need us, with support that
                                        solves problems
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-8 md:p-12 border border-indigo-100 text-center">
                        <p className="text-xl md:text-2xl text-slate-800 leading-relaxed italic">
                            ...
                            about{" "}
                            <strong>
                                strategy, support, and having the right partner
                                by your side.
                            </strong>
                            "
                        </p>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-xl text-slate-700 mb-8 leading-relaxed">
                                No templates. No compromises. Just a powerful
                                platform built specifically for you.
                            </p>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600">
                                            Every line of code written with your
                                            unique needs, brand colors, and
                                            style in mind.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600">
                                            Lightning-fast load times, clean
                                            code, and SEO best practices to help
                                            you rank higher.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600">
                                            ...
                                            reflect quality and convert visitors
                                            into students.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-gray-300 rounded-2xl p-8 aspect-square flex items-center justify-center">
                            <Image
                                src={coder}
                                alt="Comparison between generic no-code platform and BusinessTools custom solution"
                                className="max-w-full h-auto rounded-lg shadow-lg"
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-12">
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                            ...
                            <p className="text-slate-300 mb-6 leading-relaxed">
                                Our pay-as-you-go plan lets you sell your
                                knowledge without any upfront investment.
                            </p>
                        ...
                        <div className="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl p-8 border border-indigo-400 shadow-2xl">
                            ...
                            <p className="text-indigo-100 mb-6 leading-relaxed">
                                Pro plans for creators running multiple courses,
                                communities, and teams—with advanced marketing
                                tools.
                            </p>
                            <ul className="space-y-3 mb-8">
                                <li className="flex items-center space-x-3">
                    ...
                    <div className="text-center">
                        ...
                        <Link
                            ...
                            className="bg-transparent hover:bg-white/10 text-white font-semibold py-4 px-8 rounded-lg transition-all duration-200 border-2 border-white/30 hover:border-white/50 inline-flex items-center mb-4"
                        >
