      ...
      <div className="bg-gray-50 rounded-lg shadow-md p-6 md:p-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-700 mb-3">
            We offer a 14-day money-back guarantee for all our subscriptions. If you are not satisfied with our service, you may request a full refund within 14 days of your initial purchase.

            After the 14-day period, we generally do not offer refunds or credits for partial use, unused time, or early cancellation, except where required by applicable law.
          </p>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-700">
            If you believe you are eligible for a refund, please contact our support team at support@buisnesstools.in within 
        ...
        <div className="mt-8 bg-blue-50 p-4 rounded-md">
          ...
          <p className="text-gray-700">
            For any questions regarding this Refund Policy, please contact us at support@buisnesstools.incom.
          </p>
        </div>
      </div>
    </div>
