...
const faqs = [
  {
    question: "Do I need any technical knowledge or coding skills to use Buisnesstools.in?",
  ...
  {
    question: "What if I already have students or courses on another platform?",
  ...
  {
    question: "How do I ensure my online course is professional and looks good?",
