import { Headphones, Users, Lightbulb, TrendingUp, Shield, Zap } from "lucide-react";
			...
			<div className="max-w-7xl mx-auto relative z-10">
				...
				<div className="text-center mb-16">
					...
					<h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
						We're Your <span className="text-indigo-600">Partner in Success</span>
					</h2>
					<p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
						Building a course business shouldn't feel like going it alone. We combine powerful technology with hands-on guidance to help you succeed at every step of your journey.
					</p>
				</div>
				...
				<div className="grid md:grid-cols-3 gap-8 mb-16">
					...
					<div className="bg-gradient-to-br from-indigo-50 to-white p-8 rounded-2xl border border-indigo-100 hover:shadow-lg transition-shadow duration-300">
						...
						<p className="text-slate-600 mb-6 leading-relaxed">
							Real humans, real solutions. Our support team treats your success as their own mission, responding within hours—not days.
						</p>
					...
					<div className="bg-gradient-to-br from-purple-50 to-white p-8 rounded-2xl border border-purple-100 hover:shadow-lg transition-shadow duration-300">
						...
						<p className="text-slate-600 mb-6 leading-relaxed">
							Get expert advice on pricing, marketing, content strategy, and growth—without paying consultant fees.
						</p>
						<div className="space-y-2 text-sm text-slate-700">
							<div className="flex items-center">
					...
					<div className="bg-gradient-to-br from-teal-50 to-white p-8 rounded-2xl border border-teal-100 hover:shadow-lg transition-shadow duration-300">
						...
						<p className="text-slate-600 mb-6 leading-relaxed">
							We don't just give you a login. We build your entire course infrastructure so you can focus on teaching.
						</p>
						<div className="space-y-2 text-sm text-slate-700">
							<div className="flex items-center">
				...
				<div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-3xl p-12 text-white">
					<div className="grid md:grid-cols-2 gap-8 text-center text-center">
						...
						<div className="space-y-2">
							...
							<p className="text-slate-300">Platform Monitoring</p>
						</div>
						{/* <div className="space-y-2">
							<div className="flex items-center justify-center mb-2">
				...
				<div className="text-center mt-16">
					...
					<Link href={"/onboarding"} className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 px-8 rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl">
