            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                        From online courses to digital products and thriving
                        communities—launch, manage, and scale your business all
                        in one place.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <Card className="border-2 border-slate-200 hover:border-indigo-400 hover:shadow-xl transition-all duration-300 bg-white overflow-hidden group">
                        <CardHeader className="pb-4">
                            ...
                            <CardDescription className="text-slate-600 text-base">
                                Create engaging, video-based courses with
                                interactive content that keeps students coming
                                back.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-3 text-slate-700">
                            <div className="flex items-start space-x-2">
                                ...
                                <p>
                                    Unlimited video hosting with adaptive
                                    streaming
                                </p>
                            </div>
                            <div className="flex items-start space-x-2">
                            ...
                            <div className="flex items-start space-x-2">
                                ...
                                <p>
                                    Drip content scheduling for perfect pacing
                                </p>
                            </div>
                            <div className="flex items-start space-x-2">
                                <span className="text-indigo-600 font-bold mt-1">
                    ...
                    <Card className="border-2 border-slate-200 hover:border-purple-400 hover:shadow-xl transition-all duration-300 bg-white overflow-hidden group">
                        <CardHeader className="pb-4">
                            ...
                            <CardDescription className="text-slate-600 text-base">
                                Sell ebooks, templates, guides, and downloadable
                    ...
                    <Card className="border-2 border-slate-200 hover:border-teal-400 hover:shadow-xl transition-all duration-300 bg-white overflow-hidden group">
                        <CardHeader className="pb-4">
                            ...
                            <CardDescription className="text-slate-600 text-base">
                                ...
                                where your audience can connect and grow.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-3 text-slate-700">
                            <div className="flex items-start space-x-2">
                            ...
                            <div className="flex items-start space-x-2">
                                ...
                                <p>
                                    Tiered membership levels and recurring
                                    billing
                                </p>
                            </div>
                            <div className="flex items-start space-x-2">
