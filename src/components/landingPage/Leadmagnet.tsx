    ...
    async function handleDownload() {
        ...
        try {
            await sendDiscordMessage(
                `New consultancy booking request: ${email}`,
                "notification",
            );
            toast.success(
                "Thank you! We'll reach out shortly to schedule your free consultation.",
            );
            setEmail("");
        } catch (error) {
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex flex-col justify-center space-y-6">
                        ...
                        <p className="text-blue-100 text-lg leading-relaxed">
                            We know starting your first online course can be
                            overwhelming and scary. Book a free consultancy to
                            get your feet wet and receive personalized guidance
                            on launching successfully.
                        </p>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                            ...
                            <ul className="text-blue-100 space-y-1 text-sm">
                                <li>
                                    • 30-minute strategy session with an expert
                                </li>
