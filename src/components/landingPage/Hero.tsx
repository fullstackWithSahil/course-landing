				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					<div className="space-y-8">
						...
						<p className="text-xl md:text-2xl text-slate-600 leading-relaxed max-w-xl">
							We build your website, host your course, and help you grow. Your technical partner in course creation—not just software.
						</p>
						...
						<div className="space-y-3">
							<div className="flex items-center space-x-3">
								...
								<span className="text-lg text-slate-700">We build your entire course website for you</span>
							</div>
							<div className="flex items-center space-x-3">
								<CheckCircle2 className="w-6 h-6 text-green-500 flex-shrink-0" />
								<span className="text-lg text-slate-700">Free strategy consultancy included</span>
							</div>
							<div className="flex items-center space-x-3">
								<CheckCircle2 className="w-6 h-6 text-green-500 flex-shrink-0" />
								<span className="text-lg text-slate-700">No technical skills required—ever</span>
							</div>
						</div>

						{/* CTA Buttons */}
						<div className="flex flex-col sm:flex-row gap-4 pt-4">
							<Link href={"/onboarding"} className="group bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center">
								Launch Your Course Website
								<ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform duration-200" />
							</Link>
							<Link href={"#consultancy"} className="group bg-white hover:bg-slate-50 text-slate-700 font-semibold py-4 px-8 rounded-lg transition-all duration-200 border-2 border-slate-200 hover:border-slate-300 flex items-center justify-center">
						...
						<div className="relative">
							...
							<div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-xl p-4 border border-slate-200 animate-float animation-delay-2000">
								<div className="flex items-center space-x-3">
									...
									<div>
										<p className="text-sm font-semibold text-slate-900">New Student Enrolled!</p>
										<p className="text-xs text-slate-500">Advanced Marketing Course</p>
									</div>
								</div>
							</div>
						</div>
