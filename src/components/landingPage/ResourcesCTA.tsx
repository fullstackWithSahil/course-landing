...
const resources = [
    {
        ...
        description:
            "Learn how to structure, film, and launch your first online course from scratch.",
        type: "E-book",
        icon: Book,
        color: "bg-blue-500",
    },
    {
        ...
        description:
            "A comprehensive 50-step checklist to ensure your course launch is a success.",
        type: "Guide",
        icon: FileText,
        color: "bg-purple-500",
    },
    {
        ...
        description:
            "Copy and paste these proven scripts for your course landing page and emails.",
        type: "Template",
        icon: Download,
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
                        Stop guessing and start building. Access our library of
                        free ebooks, guides, and templates designed exclusively
                        for course creators.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-16">
                    {resources.map((resource, index) => (
                        ...
                        >
                            <div
                                className={`${resource.color} w-14 h-14 rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300`}
                            >
